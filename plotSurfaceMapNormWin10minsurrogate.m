...
surfaceMapOutputDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/', dataLength, filesep, session,'/surrogateData/surfaceMap/'];



for i=1:numClust
    InputName = [imgInputDir,sprintf('thresholdedStatsMap_5clusters_state%d_surrogate%d_%s_normWin.nii',i, surrogateNum, session)];
