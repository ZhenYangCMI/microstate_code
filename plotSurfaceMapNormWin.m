...
session='session2'
imgInputDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/first_5min/',session,filesep,session,'_ward_euclidean/lambdaOptimalPerSub/thresholdedStatsMap/normWin'];

surfaceMapOutputDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/first_5min/',session,filesep,session,'_ward_euclidean/lambdaOptimalPerSub/surfaceMap/normWinStatsMap'];
...
DataUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/first_5min/',session,filesep,session,'_ward_euclidean/lambdaOptimalPerSub/surfaceMap/normWinStatsMap'];

OutputUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/first_5min/',session,filesep,session,'_ward_euclidean/lambdaOptimalPerSub/surfaceMap/normWinStatsMap'];
...
OutJPGName=[OutputUpDir,filesep,num2str(totPlots),'clusters_',session,'_normWinStatsMap.jpg'];
