...
for k=81:100 % num of surrogate
    disp(['Working on surrogate_', num2str(k)])
%TRList={'645','2500'};
...
for i=1:numTR
    ...
    for j=1:numSession
        ...
        [winFullCor, winFullCorLasso, winPartialCorLasso]=FCWinCreationSurrogateDataAllSub(TR,session,subList, lambdaList);
