...
for i=1:numSession
    ...
    for i=1:numClust
        ...
        save([resultDir,session,'_ward_euclidean/lambdaOptimalPerSub/clusterMean_',num2str(numClust),'clusters_',session,'.mat'],'finalMeanWinOfClust')
        ...
        Header.pinfo = [1;0;0];
        Header.dt    =[16,0];
        rest_WriteNiftiImage(stateMap,Header,[figDir,num2str(numClust),'clusters_state', num2str(i),'_',session,'.nii']);
    end
end
