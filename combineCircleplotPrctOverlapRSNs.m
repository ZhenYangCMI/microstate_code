...
close all
DataUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/',dataLength, filesep, session,filesep,mapType,filesep, 'individual',filesep,seedNum];
...
for i=1:numRow
    for  j=1:numColumn
        k=k+1;
            ...
            imdata=imdata(20:end-20,50:1150,:);
...
OutJPGName=[OutputUpDir,filesep, session, '_', mapType, '_', seedNum, '_', num2str(k),'subplots.jpg'];
