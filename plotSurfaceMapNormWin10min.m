...
imgInputDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/',dataLength, filesep,session, filesep, mapType, filesep, seedNum, '/avgSub'];

surfaceMapOutputDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/', dataLength, filesep, session,filesep,'surfaceMap', filesep, mapType, filesep, seedNum, '/avgSub'];
...
for i=1:numImg
    ...
    OutputName = [surfaceMapOutputDir,filesep,sprintf('thresholdedStatsMap_%dclusters_state%d_allSeeds_%s_normWin', numImg, i, session),SurfaceMapSuffix];
...
close all
DataUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/',dataLength, filesep, session,filesep,'surfaceMap',filesep, mapType, filesep, seedNum];
