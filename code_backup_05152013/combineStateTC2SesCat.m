...
% This script will combine the individual TC of states into one panel
...
close all
OutputUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/', dataLength, '/2sessions/', mapType,filesep,'21sub/combined/'];
...
for k=1:numSub
    for i=1:numRow
        ...
        DataUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/',dataLength, '/2sessions/',mapType,filesep, '21sub/individual'];
