...
figdir=['/home/data/Projects/microstate/analysis_matlab/figures/'];
    ...
    for j=1:N_ses
        ...
        for n=1:N_seed-1
            for m=n+1:N_seed;
                ...
                label={'S1-S2','S1-S3','S1-S4','S2-S3','S2-S4','S3-S4'}
                legend(label(n+m))
        ...
        for n=1:N_seed
            for t=1:N_stat
                ...
                Header.pinfo = [1;0;0];
                Header.dt    =[16,0];
                rest_WriteNiftiImage(Statemap,Header,[figdir,'seed',num2str(n),'_state_', num2str(t)]);
            end
        end
    end
end
