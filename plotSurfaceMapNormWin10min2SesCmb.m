...
imgInputDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/',dataLength, filesep,session, filesep, mapType, filesep, dataType];

surfaceMapOutputDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/', dataLength, filesep, session,filesep,'surfaceMap', filesep, dataType, filesep];
...
close all
DataUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/',dataLength, filesep, session,filesep,'surfaceMap',filesep, dataType, filesep];

OutputUpDir = ['/home/data/Projects/microstate/DPARSF_preprocessed/fig/645/', dataLength, filesep, session,filesep,'surfaceMap',filesep, 'combinedPlot'];
...
OutJPGName=[OutputUpDir,filesep,dataLength, '_', session, '_', mapType, '_', dataType, '_', num2str(totPlots),'clusters.jpg'];
