function [winFullCor, winFullCorLasso, winPartialCorLasso]=FCWinCreation(TR,session,subList,lambdaList)
...
for q=1:numWinAllSub
    ...
    [W, theta, lambda, errors]=GraphicalLassoPath(normWin,lambda);
    fullCorWin(:,:,q)=W;
