...
for i=1:N_TR
    ...
    for j=1:N_ses
        ...
        save([analysisdir,'results/opt_N_clust.txt'],'opt_N_clust','-ascii', '-double', '-tabs');
        ...
        for n=1:N_seed
            ...
            [indx_stat,ctrs_stat,sumd_stat,D_stat]=kmeans(win_all_sub,N_stat,'Distance','cityblock','emptyaction','singleton','Replicates',500);
