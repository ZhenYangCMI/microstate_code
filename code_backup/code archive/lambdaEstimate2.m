function [logLikelihoodList, lambdaList]=lambdaEstimate2(session, subID)
...
for q=1:numWin
    ...
    %[WListPerWin, thetaListPerWin, lambdaListPerWin, errors] = GraphicalLassoPath(normWin,[1,2,5,10,20,50,100,120,150,200]);
