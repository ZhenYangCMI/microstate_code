...
% Output: NewColorMap - the generated color map, a 1000000 by 3 matrix.

NewColorMap = repmat(NullColor,[1000000 1]);
ColorLen=size(OriginalColorMap,1);
NegativeColorSegment = fix(1000000*(NMin-NMax)/(PMax-NMax)/(ColorLen/2));
...
PositiveColorSegment = fix(1000000*(PMax-PMin)/(PMax-NMax)/(ColorLen/2));
