...
try
    ...
    if ~isnan(theNumberCmd), %2,4,6...20 and is even!
        ...
        if strcmpi(AColorDefCmd, '**'), %Use default color map
            % This color map for plot clusters
            ...
            %colorMap=[64, 196, 255; 106, 90, 205; 0, 128,0; 30, 144, 255; 228, 108, 10; 230, 93, 184; 221, 0, 0]; % this is for < 6 clusters
             ...
             %colorMap=[ 64, 224, 208; 51, 83, 255; 106, 90, 205; 64, 196,
             %255; 30, 144, 255; 255, 230, 0; 238, 129, 0]; % plot the
             %overlap across all approaches
             %overalp across
            theColormap=colorMap/255;
            
            % below is for the threshed surface map
