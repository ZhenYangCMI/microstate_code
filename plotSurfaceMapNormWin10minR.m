...
for i=1:numClust
     InputName = [imgInputDir,sprintf('thresholdedStatsMapR_5clusters_state%d_allSeeds_%s_normWin.nii', i, session)];
    
    OutputName = [surfaceMapOutputDir,filesep,sprintf('thresholdedStatsMapR_5clusters_state%d_allSeeds_%s_normWin1', i, session),SurfaceMapSuffix];
