function [winFullCor, winFullCorLasso, winPartialCorLasso]=FCWinCreationSurrogateDataSingleSub(TR,session,subList,lambdaList, TC1)
...
%text file. Note, here subjectlist should be just one subject
%4.lambdaList: numerical e.g. [0.11 0.12]: Here should be only one number
%5. TC1: 1 surrogated time course of 4 seeds for a subject
