...
figDir=[analyDir,'fullBrainFC/figs/lambdaEstimate/'];
resultDir=[analyDir,'fullBrainFC/results/'];
...
for i=1:numSession
    ...
    parfor j=1:numSub
        ...
        [logLikelihoodList, lambdaList]=lambdaEstimate(session, subID, covType);
